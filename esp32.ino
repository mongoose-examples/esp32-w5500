...
#define SS_PIN 10            // Slave select pin for the W5500 module
#define SCLK_PIN 6
#define MOSI_PIN 7
#define MISO_PIN 2
...
struct mg_tcpip_spi spi = {
    NULL,  // SPI metadata
    [](void *) { digitalWrite(SS_PIN, LOW); SPI.beginTransaction(SPISettings(30000000, MSBFIRST, SPI_MODE0)); },
...
void setup() {
  ...
  SPI.begin(SCLK_PIN, MISO_PIN, MOSI_PIN, SS_PIN);  // Iniitialise SPI
